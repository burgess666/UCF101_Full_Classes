...
checkpointer = ModelCheckpoint(
    filepath=os.path.join('/data/d14122793/ucf101_full', 'checkpoints', 'inception.{epoch:03d}-{val_loss:.2f}.hdf5'),
    verbose=1,
    save_best_only=True)
...
def get_generators():
    ...
    train_generator = train_datagen.flow_from_directory(
        os.path.join('/data/d14122793/ucf101_full', 'train'),
        target_size=(299, 299),
        batch_size=32,
    ...
    validation_generator = test_datagen.flow_from_directory(
        os.path.join('/data/d14122793/ucf101_full', 'test'),
        target_size=(299, 299),
        batch_size=32,
        classes=data.classes,
        class_mode='categorical')
